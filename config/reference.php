 ...
 * }
 * @psalm-type BiblioverseTypesenseConfig = array{
 *     typesense: array{ // Typesense server configuration
 *         uri: scalar|null|Param, // The URL of the Typesense server
 *         key: scalar|null|Param, // The API key for accessing the Typesense server
 *         connection_timeout_seconds?: scalar|null|Param, // Default: 5
 *     },
 *     auto_update?: bool|Param, // Automatically update/remove entities from the index on flush // Default: true
 *     collections?: array<string, array{ // Default: []
 *         entity: scalar|null|Param,
 *         name?: scalar|null|Param,
 *         mapping?: array{
 *             token_separators?: list<scalar|null|Param>,
 *             symbols_to_index?: list<scalar|null|Param>,
 *             default_sorting_field?: scalar|null|Param, // Default: null
 *             metadata?: list<scalar|null|Param>,
 *             fields?: list<array{ // Default: []
 *                 name: scalar|null|Param, // The name of the field in the collection.
 *                 type: scalar|null|Param, // The type of the field in the collection.
 *                 optional?: bool|null|Param, // Default: null
 *                 facet?: bool|null|Param, // Default: null
 *                 mapped?: bool|Param, // Default: true
 *                 entity_attribute?: scalar|null|Param, // Default: null
 *                 token_separators?: list<scalar|null|Param>,
 *                 symbols_to_index?: list<scalar|null|Param>,
 *                 drop?: bool|null|Param, // Default: null
 *                 index?: bool|null|Param, // Default: null
 *                 infix?: bool|null|Param, // Default: null
 *                 rangeIndex?: bool|null|Param, // Default: null
 *                 sort?: bool|null|Param, // Default: null
 *                 stem?: bool|null|Param, // Default: null
 *                 store?: bool|null|Param, // Default: null
 *                 numDim?: int|Param, // Default: null
 *                 locale?: scalar|null|Param, // Default: null
 *                 reference?: scalar|null|Param, // Default: null
 *                 vecDist?: scalar|null|Param, // Default: null
 *                 embed?: array{
 *                     from?: list<scalar|null|Param>,
 *                     model_config?: array{
 *                         model_name: scalar|null|Param,
 *                         api_key?: scalar|null|Param, // Default: null
 *                         url?: scalar|null|Param, // Default: null
 *                     },
 *                 },
 *             }>,
 *         },
 ...
 *     biblioverse_typesense?: BiblioverseTypesenseConfig,
