 ...
 *         uri: scalar|Param|null, // The URL of the Typesense server
 *         key: scalar|Param|null, // The API key for accessing the Typesense server
 *         connection_timeout_seconds?: scalar|Param|null, // Default: 5
 *     },
 ...
 *         name?: scalar|Param|null,
 *         mapping?: array{
 *             token_separators?: list<scalar|Param|null>,
 *             symbols_to_index?: list<scalar|Param|null>,
 *             default_sorting_field?: scalar|Param|null, // Default: null
 *             metadata?: list<scalar|Param|null>,
 *             fields?: list<array{ // Default: []
 *                 name: scalar|Param|null, // The name of the field in the collection.
 *                 type: scalar|Param|null, // The type of the field in the collection.
 *                 optional?: bool|Param|null, // Default: null
 *                 facet?: bool|Param|null, // Default: null
 *                 mapped?: bool|Param, // Default: true
 *                 entity_attribute?: scalar|Param|null, // Default: null
 *                 token_separators?: list<scalar|Param|null>,
 *                 symbols_to_index?: list<scalar|Param|null>,
 *                 drop?: bool|Param|null, // Default: null
 *                 index?: bool|Param|null, // Default: null
 *                 infix?: bool|Param|null, // Default: null
 *                 rangeIndex?: bool|Param|null, // Default: null
 *                 sort?: bool|Param|null, // Default: null
 *                 stem?: bool|Param|null, // Default: null
 *                 store?: bool|Param|null, // Default: null
 *                 numDim?: int|Param, // Default: null
 *                 locale?: scalar|Param|null, // Default: null
 *                 reference?: scalar|Param|null, // Default: null
 *                 vecDist?: scalar|Param|null, // Default: null
 *                 embed?: array{
 *                     from?: list<scalar|Param|null>,
 *                     model_config?: array{
 *                         model_name: scalar|Param|null,
